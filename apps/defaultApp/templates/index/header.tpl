...
<head>
    ...
    <script type="text/javascript" src="/node_modules/metismenu/dist/metisMenu.min.js"></script>
    <link rel="stylesheet" href="/node_modules/metismenu/dist/metisMenu.min.css" type="text/css"/>
</head>
<body>
